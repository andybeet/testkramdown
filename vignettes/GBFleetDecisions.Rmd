...
The fleets designations were made after an exploratory [cluster analysis[mistake]](https://noaa-edab.github.io/ms-keyrun/GBFleetDefinitions.html) study
...
All other gear codes make up the majority (99%) of the landings. For these gear codes each species contribution to the total landings (aggregated over time) are shown as percentages. Do you see how this works 
...
[a]should you use a different method?
